...
export const initialNotifications: NotificationItem[] = [
  {
    id: 'n-1',
    title: 'July 2026 Bill Pending',
    message: 'Invoice of 7 185 TL is due on 07.08.2026 for Meter № 0767090390.',
  ...
  {
    id: 'n-2',
    title: 'Tariff Indexation Alert',
    message: 'Average kWh rate increased +104% YoY (currently 5.69 TL/kWh).',
    timestamp: '1 day ago',
    type: 'info',
    read: false,
  },
  {
    id: 'n-3',
    title: 'Usage Limit Threshold',
    message: 'You have consumed 7.4k kWh out of your 10k kWh annual quota (74%).',
  ...
  {
    id: 'n-4',
    title: 'Google Sheets Sync Success',
    message: 'All 19 invoices synchronized with spreadsheet 1bpvsP4vqHut...',
