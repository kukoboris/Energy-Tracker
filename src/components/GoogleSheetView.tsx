    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-[#94a3b8] mt-1">
            Real-time spreadsheet synchronization with document <span className="font-mono text-[#adc6ff]">1bpvsP4vqHut-g9qBGUIIz-x17DSIlpIwmU6Dcg4U2Co</span>
          </p>
        </div>
      ...
      <div className="glass-card p-5 rounded-2xl bg-[#4edea3]/5 border-[#4edea3]/20 flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-xs font-bold text-white">Cloud Spreadsheet Synchronized</p>
            <p className="text-[10px] text-[#94a3b8]">All 19 records mirrored in real-time. Last sync: {lastSyncTime}</p>
          </div>
        </div>

        <div className="flex items-center gap-4 text-xs font-mono text-[#94a3b8]">
          <span className="flex items-center gap-1">
            <Lock className="w-3.5 h-3.5 text-[#4edea3]" /> Read / Write API
          </span>
          <span className="flex items-center gap-1">
            <Share2 className="w-3.5 h-3.5 text-[#adc6ff]" /> Auto-Refresh
          </span>
        </div>
      </div>
