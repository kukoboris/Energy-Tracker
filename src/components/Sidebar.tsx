...
export const Sidebar: React.FC<SidebarProps> = ({
  ...
  const navItems = [
    ...
    { id: 'alerts', label: 'Alerts & Rules', icon: BellRing },
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="p-6 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-[10px] text-[#94a3b8] font-mono uppercase tracking-wider block">Analytics Cockpit</span>
          </div>
        </div>
        <button 
      ...
      <nav className="flex-1 px-4 space-y-2">
        ...
        <div className="pt-6 pb-2 px-4">
          <span className="text-[10px] font-bold uppercase tracking-widest text-[#94a3b8]">External Tools</span>
        </div>
      ...
      <div className="p-4 mt-auto">
        <div className="glass-card p-4 rounded-2xl bg-[#adc6ff]/5 border-[#adc6ff]/10">
          <div className="flex justify-between items-center mb-2">
            <p className="text-[10px] font-bold text-[#adc6ff] uppercase tracking-wider">Usage Limit</p>
          ...
          <p className="text-[10px] text-[#c2c6d6] mt-2 font-mono">
            {(account.currentUsageKwh / 1000).toFixed(1)}k / {(account.usageLimitKwh / 1000).toFixed(0)}k kWh used
          </p>
        </div>
      </div>
    </div>
