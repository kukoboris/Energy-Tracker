      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-[#94a3b8] mt-1">
            View, filter, pay, or export all electricity statement records for Meter № 0767090390
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="glass-card p-5 rounded-2xl border-[#4edea3]/20">
          <div className="flex justify-between items-center mb-2">
            <span className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-widest">Total Paid (All)</span>
        ...
        <div className="glass-card p-5 rounded-2xl border-[#f59e0b]/20">
          <div className="flex justify-between items-center mb-2">
            <span className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-widest">Pending Payment</span>
          ...
          <p className="text-[10px] text-[#f59e0b] mt-1 font-mono">
            {invoices.filter(i => i.status === 'PENDING').length} bill due soon
          </p>
        </div>

        <div className="glass-card p-5 rounded-2xl border-[#adc6ff]/20">
          <div className="flex justify-between items-center mb-2">
            <span className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-widest">Total Energy Usage</span>
            <Zap className="w-4 h-4 text-[#adc6ff]" />
          </div>
          <p className="text-2xl font-bold font-mono text-white">
            {totalKwh.toLocaleString('ru-RU')} <span className="text-xs text-[#94a3b8] font-normal">kWh</span>
          </p>
          <p className="text-[10px] text-[#adc6ff] mt-1 font-mono">
            Cumulative meter total
          </p>
        </div>

        <div className="glass-card p-5 rounded-2xl border-[#8b5cf6]/20">
          <div className="flex justify-between items-center mb-2">
            <span className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-widest">Avg Monthly Cost</span>
            <DollarSign className="w-4 h-4 text-[#8b5cf6]" />
          </div>
          <p className="text-2xl font-bold font-mono text-white">
            {avgMonthlyCost.toLocaleString('ru-RU')} <span className="text-xs text-[#94a3b8] font-normal">TL/mo</span>
          </p>
          <p className="text-[10px] text-[#8b5cf6] mt-1 font-mono">
            Across 19 billing cycles
          </p>
        </div>
      </div>
      ...
      <div className="glass-card p-4 rounded-2xl flex flex-col lg:flex-row gap-4 items-center justify-between">
        <div className="relative w-full lg:w-96">
          ...
          <input
            ...
            placeholder="Search by period, bill date, TL..."
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          ...
          >
            ...
            <span className="capitalize">Sort: {sortField.replace('_', ' ')}</span>
          </button>
        </div>
      </div>
          ...
          <table className="w-full text-left">
            <thead>
              <tr className="text-[10px] font-bold text-[#94a3b8] uppercase tracking-widest border-b border-[#424754] bg-[#151b2d]/60">
                ...
                <th className="py-4 px-5">Usage (kWh)</th>
        ...
        <div className="fixed inset-0 bg-black/70 backdrop-blur-md z-50 flex items-center justify-center p-4">
          <div className="glass-card bg-[#161e2e] border border-[#424754] p-6 rounded-3xl max-w-md w-full shadow-2xl">
            <h3 className="text-xl font-bold text-white mb-2 flex items-center gap-2">
              ...
              Add Electricity Statement
            </h3>
            <p className="text-xs text-[#94a3b8] mb-6">
              Simulate uploading or manual input for a new meter reading statement.
            </p>
            ...
            <form onSubmit={handleCreateInvoiceSubmit} className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                <div>
                  <label className="block text-[10px] font-bold uppercase text-[#94a3b8] mb-1">Rate (TL/kWh)</label>
                  <input
                    type="number"
                    step="0.001"
                    required
